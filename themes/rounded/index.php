...
function pricingtable_body_rounded($post_id)
	{
		...
		$pricingtable_cell_signup_url = get_post_meta( $post_id, 'pricingtable_cell_signup_url', true );
				...
				while($j<=$pricingtable_total_column)
					...
					$pricingtable_body.=  '<div  style="width:'.$pricingtable_column_width[$j].'px;height:'.$pricingtable_column_width[$j].'px; background-color:'.$pricingtable_cell_signup_bg_color[$j].'"  class="pricingtable-columns" >';
